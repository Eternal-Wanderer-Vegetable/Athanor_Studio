fn main() {
    // Tauri's Windows resource step requires an icon. Generate a tiny valid
    // placeholder during local builds; release branding can replace it in a
    // later packaging step without changing the command bridge.
